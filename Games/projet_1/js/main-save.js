...
function preload() {
    ...
    game.load.image('space', 'assets/kosmos.jpg');
    game.load.image('fire', 'assets/fire.png');
    game.load.image('station', 'assets/spacestationfinal.png');
    game.load.image('btnPause', 'assets/btn-pause.png');
    game.load.image('bullet', 'assets/bullet.png');
    game.load.image('bullet2', 'assets/lazer2.png');
    game.load.image('enemyBullet', 'assets/bullet285.png');
    game.load.image('enemyBullet2', 'assets/laser2.png');
    game.load.image('bossBullet', 'assets/laser-boss.png');
    game.load.image('life', 'assets/life.png');
    game.load.image('lifeBoss', 'assets/life-boss.png');
    game.load.image('boss', 'assets/tribase-u2-d0.png');
    game.load.spritesheet('ship', 'assets/ship.png', 125, 90);
    game.load.spritesheet('invader', 'assets/enemy.png', 40, 40);
    game.load.spritesheet('invader2', 'assets/eSpritesheet_40x30_hue3.png', 40, 30);
    game.load.spritesheet('kaboom', 'assets/explode1.png', 155, 150);
