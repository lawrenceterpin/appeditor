...
var game = new Phaser.Game(700, 600, Phaser.CANVAS, 'flappyBird', { preload: preload, create: create, update: update, render: render });
...
function create () { 
    ...
    pvText = game.add.text(game.world.centerX, game.world.centerY, '100', { font: "40px Arial", fill: "#ffffff", align: "center" });

    stateNbCoins = game.add.text(game.world.centerX+80,40,' ', { font: "40px Arial", fill: "#ffffff", align: "center" });
