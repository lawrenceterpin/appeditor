...
class Routeur
{
    ...
    private function creerControleur(Requete $requete)
    {
        ...
        if ($requete->existeParametre('controleur')) {
          	...
          	// Si on est pas connecté on redirige vers le controleur de connexion
        ...
        if (file_exists($fichierControleur)) {
            ...
            // $class_page = 'page-'.$requete->getParametre('controleur');
            
            
            // var_dump($class_page);
            
            // var_dump($requete->getParametre('controleur'));
