...
create table T_FILES (
  ...
  FILE_AUTEUR varchar(400) not null
...
create table T_GAME (
  ...
  GAME_CONTENU varchar(400) not null
) ENGINE=INNODB CHARACTER SET utf8 COLLATE utf8_general_ci;
...
create table T_PAGES (
  ...
  PAGE_CONTENU MEDIUMTEXT not null
) ENGINE=INNODB CHARACTER SET utf8 COLLATE utf8_general_ci;



# INSERT
insert into T_FILES(FILE_DATE, FILE_NAME, FILE_AUTEUR) values
(NOW(), 'test.js', 'lawadmin');
insert into T_FILES(FILE_DATE, FILE_NAME, FILE_AUTEUR) values
(NOW(), 'test2.js', 'admin');
...
insert into T_GAME(GAME_DATE, GAME_TITRE, GAME_CONTENU) values
(NOW(), 'Premier GAME', 'Bonjour monde ! Ceci est le premier GAME sur mon blog.');
insert into T_GAME(GAME_DATE, GAME_TITRE, GAME_CONTENU) values
(NOW(), 'Au travail', 'Il faut enrichir ce blog dès maintenant.');
